...
public class AppController {
    ...
    public ResponseEntity<?> generate(@RequestBody NewTinyRequest request) throws JsonProcessingException {
        ...
        return new ResponseEntity<>((baseUrl + tinyCode + "/"),HttpStatus.ACCEPTED);
    }
